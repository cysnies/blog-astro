...
title: 为 Astro Paper 引入 mdx 与 Aplayer 组件
slug: mdx-and-aplayer
featured: false
tags:
  - 博客
  - 个人相关
description: "她现在支持 APlayer 内嵌播放器辣！"
---

花了大半个上午的时间，在 DeepSeek 的帮助下为 Astro Paper 主题引入了 [mdx](https://mdxjs.com/docs/what-is-mdx/) 和 [APlayer](https://aplayer.js.org/) 支持。
